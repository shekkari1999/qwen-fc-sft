"""
Stage 1: Chat SFT - Teach base model to follow instructions
Run on RunPod with A6000 GPU

Usage: python train_stage1.py
"""
...
# Load dataset
print("\nLoading dataset...")
dataset = load_dataset("shekkari21/qwen-fc-sft-data", split="stage1_chat")
