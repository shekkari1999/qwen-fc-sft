"""
Stage 1 MINIMAL: Train on 200 short Q&A pairs
Test if model learns to stop with short data

Usage:
1. python scripts/create_minimal_data.py
2. python scripts/train_stage1_minimal.py
"""
...
print("\nDone! Test with: python scripts/test_inference_v2.py")
print("(Update MODEL_PATH to ./checkpoints/stage1_minimal/merged)")
