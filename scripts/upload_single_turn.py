"""
Upload single-turn datasets to HuggingFace Hub
Usage: python scripts/upload_single_turn.py
"""

from datasets import load_dataset, DatasetDict

HF_USERNAME = "shekkari21"
REPO_NAME = "qwen-fc-sft-data-v2"  # New version with single-turn

def main():
    print("="*60)
    print("Uploading SINGLE-TURN datasets to HuggingFace Hub")
    print("="*60)

    # Load processed datasets
    print("\nLoading Stage 1 (Chat) single-turn data...")
